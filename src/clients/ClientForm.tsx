        ...
        <>
            ...
            <form onSubmit={handleFormHookSubmit(handleSubmit)} className="flex flex-col gap-5">
                ...
                <TextField {...register("name")}
                    ...
                    disabled={disabled} />
                <TextField {...register("companyDetails.name")}
                    label="Company Name"
                    placeholder="Toptal"
                    error={!!errors.companyDetails?.name}
                    helperText={errors.companyDetails?.name?.message}
                    disabled={disabled} />
                <TextField {...register("companyDetails.vatNumber")}
                    ...
                    disabled={disabled} />
                <TextField {...register("companyDetails.regNumber")}
                    ...
                    disabled={disabled} />
                <TextField {...register("companyDetails.address")}
