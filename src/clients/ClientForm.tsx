...
const ClientForm = ({ onSubmit, formError, disabled, defaultValues }: ClientFormProps) => {
    const { register, handleSubmit: handleFormHookSubmit, formState: { errors } } = useForm<ClientValues>({
    ...
    return (
        <>
            {formError && (
                <p className='text-red-400' data-test='form-error'>{formError}</p>
            )}
            <form onSubmit={handleFormHookSubmit(handleSubmit)} className='flex flex-col gap-5'>
                ...
                <TextField
                    ...
                    helperText={(
                        errors.companyDetails?.name && <span data-test='client-company-name-error'>
                ...
                <TextField
                    ...
                    helperText={(
                        errors.companyDetails?.vatNumber && <span data-test='client-company-vat-error'>
                ...
                <TextField
                    ...
                    helperText={(
                        errors.companyDetails?.regNumber && <span data-test='client-company-reg-error'>
                ...
                <TextField
                    ...
                    helperText={(
                        errors.companyDetails?.address && <span data-test='client-company-address-error'>
